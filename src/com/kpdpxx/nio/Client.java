...
public class Client implements Runnable {
	...
	public Client() throws IOException {
		...
		Boolean isConnected = socketChannel.connect(new InetSocketAddress("127.0.0.1", 8080));
...
//						System.out.println("Client received ["+msg+"] from server address:" + sc.getRemoteAddress());
						System.out.println("Client received ["+msg+"] from server address:" );
